...
class dk extends CI_Controller {
	...
	public function addRecord(){
			...
			$this->form_validation->set_rules('minbed','minbed','trim|required|numeric');
			$this->form_validation->set_rules('maxbed','maxbed','trim|required|numeric');
	  	    $this->form_validation->set_rules('minprice','minprice','trim|required|numeric');
			$this->form_validation->set_rules('maxprice','maxprice','trim|required|numeric');
...
function find(){
	...
	if($query=$this->dk_model->search_selected($ref)){
